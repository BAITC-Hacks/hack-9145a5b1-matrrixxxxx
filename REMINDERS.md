...
Сервис связан с серверной записью на сессию: расписание и часовой пояс берутся из сессии организатора.

Путь подключения: **записаться на сессию в каталоге → «Подключить Telegram» → выбрать свою запись → «Получить одноразовую ссылку» → «Открыть Telegram» → Start**. На странице `/telegram.html` есть мини-инструкция, согласие на напоминания, копирование ссылки и статус подключения. Истёкшую или потерянную ссылку можно перевыпустить в «Моих подключениях» без новой записи. Новая ссылка аннулирует прежнюю.
