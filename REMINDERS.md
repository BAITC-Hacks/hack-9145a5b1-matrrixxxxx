...
Новый путь подключения: **«Подключить Telegram» → выбрать мероприятие → «Получить одноразовую ссылку» → «Открыть Telegram» → Start**. На странице `/telegram.html` есть мини-инструкция, согласие на напоминания, копирование ссылки и статус подключения. Истёкшую или потерянную ссылку можно перевыпустить в «Моих подключениях» без новой записи. Новая ссылка аннулирует прежнюю.
